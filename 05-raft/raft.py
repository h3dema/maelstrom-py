...
To test:
* key-value store
../maelstrom/maelstrom test -w lin-kv --bin raft.py --time-limit 10 --node-count 2 --rate 10 --concurrency 2n

* Leader election
../maelstrom/maelstrom test -w lin-kv --bin raft.py --time-limit 10 --node-count 3 --concurrency 2n --rate 0 --log-stderr
